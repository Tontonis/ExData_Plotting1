...
#png(filename = "F:/ExData_Plotting1/plot3.png",width = 480, height = 480)
plot(x=datLim$datetime,y=datLim$Sub_metering_1,xlab="",ylab="Energy sub metering",ylim=c(0,40),type="l",col="black",yaxt='n')
lines(x=datLim$datetime,y=datLim$Sub_metering_2,col="red")
lines(x=datLim$datetime,y=datLim$Sub_metering_3,col="blue")
